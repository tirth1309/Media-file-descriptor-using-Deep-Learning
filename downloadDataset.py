...
def download_and_process( video_save_path):
    video_id = 'DDtX5a-OgLQ'
    #file_name = row['file_name']
    path = os.path.join( video_save_path, 'DDtX5a-OgLQ.avi' )
...
def main():
    ...
    video_save_path="./Downloaded_test_videos"	
    ...
    #for i in range(len(data)):
     ...
     #       continue
    x = download_and_process(video_save_path)
